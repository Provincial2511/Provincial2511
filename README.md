...
|----------------|-----------------|-----------|
|🏆 [ШММ НОЦ ИТМО]([https://github.com/Provincial2511/GPN_CUP_2024](https://github.com/Provincial2511/Image-Based-3D-Reconstruction))|Генерация 3D-объектов по одному 2D-изображению| Python, PyTorch, OpenCV, Matplotlib, Scikit-learn, Numpy|
